...
description: Writingale collects no data about you. Here is what that means in detail.
---
...
A book in Writingale is a folder of plain Markdown files on your own
disk. Writingale reads and writes those files where you put them, and
nowhere else. It has no cloud service, no sync, no backup service and
no account system.

If you keep your book in a folder that something else syncs — iCloud
Drive, Dropbox, a network share — then that service handles your files
under its own privacy policy. Writingale is not involved in that and
cannot see it.

## What Writingale stores, and where

Everything below stays on your Mac. None of it leaves your computer.

| What | Where |
|---|---|
| Your book: prose, characters, notes, pictures | The book folder you chose |
| Writing statistics and goal history | Inside the book folder, in `.writingale` |
| Which panes and tabs you had open | Inside the book folder, in `.writingale` |
| Your list of recent books, and permission to reopen them | Writingale's own storage on your Mac |
...
Saving is unlocked by a one-time in-app purchase. **That purchase is
handled entirely by Apple.** Writingale never sees your name, your
...
There are no analytics libraries, no crash-reporting services, no
advertising networks and no third-party trackers in Writingale. No data
about you or your writing is shared with anyone, because none is
...
If this policy ever changes, the date at the top changes with it. If a
future version of Writingale ever collected anything — which is not
planned — that would be stated here plainly and before it happened.
